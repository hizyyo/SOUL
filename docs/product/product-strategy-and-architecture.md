# SOUL Product Strategy and Architecture
...
Этот документ фиксирует продуктовую стратегию, архитектурные границы, модель валидации и долгосрочное направление SOUL.
