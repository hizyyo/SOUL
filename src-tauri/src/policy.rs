...
//! модели: безопасное типизированное подмножество условий,
...
//! обязателен для всех высокорисковых действий).
...
/// Эффект решения, поддерживаемый текущей P0-моделью.
...
/// Правила нужны UI-демо и локальному Gateway-демо.
