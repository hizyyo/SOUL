...
pub struct DisclosureReceipt {
    ...
    pub max_tokens: i64,
    /// Оценочная стоимость входных токенов контекста, USD.
...
/// Агрегированная статистика раскрытий контекста: сколько раз
...
/// Агрегированная статистика раскрытий контекста из каталога
