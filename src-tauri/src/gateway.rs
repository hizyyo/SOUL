//! Локальный имитированный Gateway.
//!
...
//! политик и при разрешении выпускает локальную capability — action id,
...
//!
//! Capability привязывает канал (коннектор/учётная
...
//!
//! Сохранённая нагрузка не считается доверенной: при
...
//! хранилища вместе с демонстрационными политиками и может управляться пользователем.
...
/// первой версии схемы). Имена таблиц/колонок — константы, не пользователь.
...
/// `gateway_meta`) вместе с демонстрационными политиками. Канал выполнения должен
